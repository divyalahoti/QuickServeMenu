...
const Home = () => {
  ...
  return (
    <div className="kiosk-home" onClick={() => navigate("/ordertype")}>
      <Link to="/login" className="user-profile-trigger" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="kiosk-content">
        <main className="main-cta">
          ...
          <div className="button-container" data-aos="zoom-up" data-aos-delay="1000">
            <button className="kiosk-button-animated">
